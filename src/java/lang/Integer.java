...
//        return IntegralToString.intToString(i);
		...
		if (neg) str[--n] = '-';
		return new String(str, n, str.length - n);
    }
	 ...
	 * 
	 * @param string 
	 * 				the <code>char</code> array who represents the string.
	 * @param off 
	 * 				the start position of the <code>char</code> array.
	 * @param val 
	 * 				the <code>integer</code> to convert.
