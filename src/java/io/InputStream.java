 ...
 */
public abstract class InputStream extends Object implements Closeable, Modified {
...
//        Arrays.checkOffsetAndCount(buffer.length, byteOffset, byteCount);
        ...
        if ((byteOffset | byteCount) < 0 || byteOffset > arrayLength || arrayLength - byteOffset < byteCount) {
        	throw new ArrayIndexOutOfBoundsException(arrayLength, byteOffset, byteCount);
        }
