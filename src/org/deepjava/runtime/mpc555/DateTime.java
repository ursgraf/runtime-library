...
import org.deepjava.runtime.mpc555.driver.DS1302Z;
import org.deepjava.runtime.ppc32.Task;

/**
 * Date and time class. This class reads the date and time
 * from the {@link org.deepjava.runtime.mpc555.driver.DS1302Z} real time clock. 
 * The time is updated with a periodic {@link org.deepjava.runtime.ppc32.Task}. <br>
...
public class DateTime extends Task {
	...
	/**
	 * @see org.deepjava.runtime.ppc32.Task#action()
	 */
	public void action() {
	...
	/**
	 * Update the time from the {@link org.deepjava.runtime.mpc555.driver.DS1302Z} real time clock.
	 */
	private void  update() {
		sec = DS1302Z.getSec();
		min = DS1302Z.getMin();
	...
	/**
	 * Sets the actual time and writes it to the {@link org.deepjava.runtime.mpc555.driver.DS1302Z} real time clock.
